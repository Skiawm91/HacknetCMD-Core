...
export extern string kbPrompt;
export extern atomic<bool> escDetected;
export extern atomic<bool> enterDetected;
export extern atomic<bool> inputMasked;
export extern atomic<bool> inputAte;
export extern atomic<bool> kbEnabled;
export extern atomic<bool> running;
export extern atomic<bool> runningKb;
export extern atomic<bool> runningMouse;
export extern atomic<bool> mouseSync;
#ifdef __APPLE__
export extern atomic<bool> isQuary;
export extern atomic<int> cursorRow;
export extern atomic<int> cursorCol;
#endif
